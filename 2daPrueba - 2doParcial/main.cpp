...
//					else 
//						cout << line2; 
				if(strcmpi(DataType,"numerico") == 0) {
					for(int k = 0; k < num[i]; k++){
						pil_num[i].Anadir(atoi(split));
						split = strtok(NULL,",");
					}
				} else if(strcmpi(DataType,"caracter") == 0) {
					for(int k = 0; k < num[i]; k++){
						pil_char[i].Anadir(*split);
						split = strtok(NULL,",");
					}
				} else if(strcmpi(DataType,"cadena") == 0) {
					for(int k = 0; k < num[i]; k++){
...
//				cout << endl;					
			...
			-----> COLA
			*/
			} else if(strcmpi(Structure,"cola") == 0) {
//				cout << "**COLA**" << endl;
//				cout << "Elemento " << i+1 << ": ";
//					if(i==0) 
//						cout << line; 
...
//				cout << endl;
			...
			-----> LISTA
			*/
			} else if(strcmpi(Structure,"lista") == 0) {
//				cout << "**LISTA**" << endl;
//				cout << "Elemento " << i+1 << ": ";
//					if(i==0) 
//						cout << line; 
...
//				cout << endl;
		...
		if(strcmpi(split,"pila")) {
			tipo = 1;
		} else if(strcmpi(split,"cola")) {
			tipo = 2;
		} else if(strcmpi(split,"lista")){
			tipo = 3;
		}	
			split = strtok(NULL,", 	");	
		/*
		...
		*/
		if(strcmpi(Operation,"revertir") == 0) {
		...
		} else if(strcmpi(Operation,"ordenar") == 0) {
		...
		} else if(strcmpi(Operation,"mezclar") == 0) {
		...
		} else if(strcmpi(Operation,"convertir") == 0) {
		...
		} else if(strcmpi(Operation,"concatenar") == 0) {
			if(strcmpi(Structure,"pila") == 0) {
				if(strcmpi(DataType,"numerico")) {
					pil_num[0].concat(pil_num[1],tipo);
				} else if(strcmpi(DataType,"caracter")) {
					cout << "SI 3";
					pil_char[0].concat(pil_char[1],tipo);
				} else if(strcmpi(DataType,"cadena")) {
					cout << "SI 3";
					pil_string[0].concat(pil_string[1],tipo);
				}
			} else if(strcmpi(Structure,"cola")) {
				if(strcmpi(DataType,"numerico")) {
			...
			} else if(strcmpi(Structure,"lista")) {
				if(strcmpi(DataType,"numerico")) {
